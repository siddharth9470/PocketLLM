import { buildCompletedModel, MOCK_DOWNLOADED_AT, MOCK_HF_MODELS, mockExecute } from "@tests/testUtils";
...
function getInsertCall(): [string, unknown[]] {
  ...
  if (!call) throw new Error("Expected a downloaded_models INSERT statement.");
...
describe("ModelDB", () => {
  ...
  describe("when persisting a completed model download", () => {
